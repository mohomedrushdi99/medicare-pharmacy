...
const productionOrigins = [
  "https://medicare-pharmacy-alpha.vercel.app",
  "https://medicare-pharmacy.vercel.app",
];
const trustedOrigins: string[] = [
  ...(explicitBaseURL ? [explicitBaseURL] : []),
  ...productionOrigins,
  ...LOCAL_DEV_ORIGINS,
  // Preview / dynamic hosts
  ...previewAllowedHosts,
...
export const auth = betterAuth({
  ...
  // Single operator model: public sign-up stays enabled only so the server can
  // seed the one operator account; the UI no longer offers "Create account".
