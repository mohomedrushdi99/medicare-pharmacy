...
>(({ side = "left", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 flex h-full flex-col bg-sidebar text-sidebar-foreground shadow-xl transition ease-out data-[state=open]:animate-in data-[state=closed]:animate-out",
        side === "left"
